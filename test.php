                ...
                <div class="row">
                    <div class="col-3">
                        <ul class="app__sidebar-list">
                            ...
                            <li class="app__sidebar-item">
                                <a href="./Customer's_Review.php" class="text-decoration-none text-dark">
                                    Your Reviews
                                </a>
                            </li>
                            <li>
                    ...
                    <div class="col-9">
                        ...
                        <form action="./HandleUpdateCus.php?Update=1" method="post" class="form-detail" id="form-detail"
                            ...
                            <div class="form-avatar">
                                ...
                                ?>
                                <input type="file" name="app__main-input-img" id="app__main-input-img" 
                                            hidden disabled>
                            </div>
                            ...
                            <div class="form-info">
                                <div class="form-group">
                                    ...
                                    <input id="yourname" name="yourname" type="text" placeholder="Your Name" disabled
                                        class="form-control edit-active"  value="<?php echo $cus_name;?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" type="text" placeholder="Your Email" disabled
                                        class="form-control" value="<?php echo $Gmail;?>">
                                    <span class="form-message"></span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="sex" name="sex" class="form-control edit-active" disabled style="font-size: 14px;">
                                        ...
                                        <option value="0" <?php if($sex == 0){ echo "selected='selected'";}?>>Nam</option>
                                        <option value="1" <?php if($sex == 1){ echo "selected='selected'";}?>>Nữ</option>
                                    </select>
                                    <span class="form-message"></span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input id="phonenumber" name="phonenumber" placeholder="Phone number" disabled
                                        type="text" class="form-control edit-active" value="<?php echo $phone;?>">
                                    <span class="form-message"></span>
                                </div>
    
                                <div class="buttons-handle">
                                    <button class="form-edit">Edit details</button>
                                    <input type="submit" class="form-edit" name="btnUpdate" value="Accept" disabled>
                                </div>
                            </div>
                        </form>
                    </div>
