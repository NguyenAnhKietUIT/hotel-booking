...
<body>
    <div id="wrapper">
                    ...
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
                            <span class="user-profile">
                                <img src="https://i1.wp.com/whcouncil.org/wp-content/uploads/2016/10/male-avatar.jpg?w=1080" class="img-circle" alt="user avatar">
                            </span>
                        </a>
                                ...
                                <a href="javaScript:void();">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="user-subtitle">admin@gmail.com.vn</p>
                                        </div>
                                    </div>
                                </a>
                            </li>
                                ...
                                <table id="table-customer" class="table mb-2">
                                    ...
                                    ?>
                                        <tr>
                                                ...
                                                <td>
                                                    <?php if($row1[2] == 0){ echo "Nam";} else {echo "Nữ";} ?>
                                                </td>
                                                <td>
                                                    <?php if($row1[3] == 0){ echo "Inactive";} else {echo "Active";} ?>
                                                </td>
                                                <td>
                                                    <?php 
                                                ...
                                                <td>
                                                    <button class="btn btn-info inactive" type="submit" 
                                                            onclick="findInform(this)" name="btnActivate">Active account</button>
                                                </td>
                                        </tr>
                                    <?php } ?>
                                </table>
        ...
        <!-- Xử lý lấy thông tin của table cần Update -->
        <script>
                function findInform(button) {
                    function find_pos(row, x) {
                            var updateTableCells = document.querySelector("#table-customer").rows[row].cells; // lấy ra các cell của 1 row
